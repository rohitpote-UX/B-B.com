         ...
         <div className="w-full max-w-md mx-auto">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1], delay: 0.1 }}>
               ...
               <p className="mt-16 text-center text-[0.875rem] text-theme-secondary">
                  Already hold clearance? <Link to="/login" className="text-theme-text font-medium border-b border-transparent hover:border-theme-text transition-all duration-300 ml-2 py-0.5">Authenticate</Link>
               </p>
            </motion.div>
         </div>
      </div>
