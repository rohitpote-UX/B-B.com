    ...
    <div className="min-h-screen pt-32 pb-40">
      <div className="w-full max-w-[1536px] mx-auto px-8 md:px-16">
        ...
        <div className="mb-24 max-w-3xl">
           ...
           <form onSubmit={e => { e.preventDefault(); setSearchParams(query ? { q: query } : {}) }} className="flex items-center border-b border-theme-border pb-8 focus-within:border-theme-text transition-colors">
        ...
        <motion.div layout className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-12 gap-y-24">
          <AnimatePresence mode="popLayout">
            {filtered.map((product, i) => (
              ...
              >
              <Link to={`/product/${product.id}`} className="group block group">
