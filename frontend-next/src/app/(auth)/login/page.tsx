         ...
         <div className="w-full max-w-md mx-auto">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1], delay: 0.1 }}>
               ...
               <form onSubmit={handleLogin} className="space-y-12">
                  ...
                  <div className="relative group">
                     ...
                     <div className="absolute right-0 top-3">
                          <Link href="#" className="text-[0.65rem] uppercase tracking-widest text-theme-secondary hover:text-theme-text transition-colors">Forgot?</Link>
                     </div>
                  </div>
               ...
               <p className="mt-16 text-center text-[0.875rem] text-theme-secondary">
                  No access clearance? <Link href="/signup" className="text-theme-text font-medium border-b border-transparent hover:border-theme-text transition-all duration-300 ml-2 py-0.5">Request Account</Link>
               </p>
            </motion.div>
         </div>
      </div>
