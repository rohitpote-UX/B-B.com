          ...
          <div className="col-span-12 lg:col-span-8 flex flex-col justify-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-8 mt-12">
                <Link href="/compare" className="inline-flex items-center justify-center px-10 py-5 bg-transparent border border-theme-text text-theme-text text-[0.875rem] font-medium tracking-wide transition-all duration-300 rounded-[2px] hover:bg-theme-text hover:text-theme-bg">
                  Start Comparison
                </Link>
                <Link href="/search" className="inline-flex items-center justify-center px-10 py-5 bg-transparent border border-theme-border text-theme-text text-[0.875rem] font-medium tracking-wide transition-all duration-300 rounded-[2px] hover:border-theme-text">
                  Explore Catalog
                </Link>
              </div>
            </motion.div>
        ...
        <div className="w-full max-w-[1536px] mx-auto px-8 md:px-16">
          <FadeUp className="mb-32 flex flex-col md:flex-row md:items-end justify-between gap-12">
            <div>
             ...
             <Link href="/search" className="text-[0.75rem] font-medium uppercase tracking-[0.15em] hover:text-theme-text transition-colors flex items-center gap-2">
        ...
        <div className="w-full max-w-[1536px] mx-auto px-8 md:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-[160px] items-center">
             ...
             <FadeUp className="order-1 lg:order-2 lg:pl-20">
                ...
                <Link href="/about" className="inline-flex items-center justify-center px-10 py-5 bg-transparent border border-theme-border text-theme-text text-[0.875rem] font-medium tracking-wide transition-all duration-300 rounded-[2px] hover:border-theme-text">Read The Manifesto</Link>
             </FadeUp>
          </div>
        </div>
      </section>
      ...
      <section className="py-[140px] lg:py-[240px]">
        <div className="w-full max-w-[1536px] mx-auto px-8 md:px-16">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
              {DEALS.slice(0, 3).map((deal, i) => (
                 <FadeUp key={deal.id} delay={i * 0.1}>
                    <Link href={`/product/${deal.product.id}`} className="group block">
           ...
           <FadeUp className="mt-16 text-center">
              <Link href="/deals" className="inline-flex items-center justify-center px-10 py-5 bg-transparent border border-theme-border text-theme-text text-[0.875rem] font-medium tracking-wide transition-all duration-300 rounded-[2px] hover:border-theme-text">View All Deals</Link>
           </FadeUp>
        </div>
      </section>
